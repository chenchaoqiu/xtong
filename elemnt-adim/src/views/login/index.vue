<template>
  <div class="login-container">
    ...
    <el-form class="login-form" autoComplete="off" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <el-button type="primary" style="width:100%;margin-bottom:20px;height: 51px;" :loading="loading" @click.native.prevent="handleLogin">{{$t('login.logIn')}}</el-button>
        <router-link style="color:#fff;font-size: 17px;float: right;" to="/pass">忘记密码？</router-link>
    </el-form>
